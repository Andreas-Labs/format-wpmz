...
export class KMLTemplate {
    ...
    constructor(data: Partial<KMLTemplate> = {}) {
        ...
        this.missionConfig = {
            ...
            exitOnRCLost: 'executeLostAction',
            executeRCLostAction: 'hover',
            globalTransitionalSpeed: data.missionConfig?.globalTransitionalSpeed ?? 12,
            droneInfo: {
                droneEnumValue: data.missionConfig?.droneInfo?.droneEnumValue ?? 68,
                droneSubEnumValue: data.missionConfig?.droneInfo?.droneSubEnumValue ?? 0
            }
        };
    }
                        ...
                        },
                        {
                            ...
                            children: [
                                ...
                                },
                                {
                                    ...
                                    attributes: {},
                                    children: [],
                                    textContent: this.missionConfig.globalTransitionalSpeed.toString()
                                },
                                {
                                    tagName: 'droneInfo',
                                    namespace: 'wpml',
                                    ...
                                    children: [
                                        {
                                            ...
                                            attributes: {},
                                            children: [],
                                            textContent: this.missionConfig.droneInfo.droneEnumValue.toString()
                                        },
                                        {
                                            ...
                                            attributes: {},
                                            children: [],
                                            textContent: this.missionConfig.droneInfo.droneSubEnumValue.toString()
                                        }
                                    ],
                                    textContent: ''
                                }
